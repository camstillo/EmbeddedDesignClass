 ...
 *
 *   This version if for the NexysA7 (Nexys4 DDR):
 *   	pushbutton mapping: {btnD, btnR, btnL, btnU, btnC}
 */
#include <stdio.h>
#include <stdbool.h>
#include "platform.h"
...
int main() {
    ...
    init_platform();
    xil_printf("Microblaze MCS/Nexys A7 Getting Started Project by Roy Kravitz (roy.kravitz@pdx.edu)\n\r");

    XIOModule_Initialize(&IOModule, XPAR_XIOMODULE_0_BASEADDR);//XPAR_IOMODULE_0_DEVICE_ID);
    while(1){
