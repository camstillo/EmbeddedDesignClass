...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L microblaze_v11_0_13 -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_15 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_24 -L blk_mem_gen_v8_4_8 -L axi_lite_ipif_v3_0_4 -L mdm_v3_2_26 -L xlconcat_v2_1_6 -L iomodule_v3_1_10 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot embsys xil_defaultlib.embsys xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim embsys -key {Behavioral:sim_1:Functional:embsys} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_0ac7.protoinst" -protoinst "protoinst_files/embsys.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="A:/Xilinx/Vivado/2024.1/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb embsys.wdb xsim.dir libdpi.so)
