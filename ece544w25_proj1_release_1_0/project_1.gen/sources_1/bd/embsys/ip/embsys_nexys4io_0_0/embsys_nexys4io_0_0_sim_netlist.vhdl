...
-- Date        : Sun Jan 26 21:29:18 2025
-- Host        : DESKTOP-BFRN34B running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               a:/ECE544_GitHub/ece544w25_proj1_release_1_0/project_1.gen/sources_1/bd/embsys/ip/embsys_nexys4io_0_0/embsys_nexys4io_0_0_sim_netlist.vhdl
...
entity embsys_nexys4io_0_0_Digit_3 is
  port (
    ...
    Q : in STD_LOGIC_VECTOR ( 5 downto 0 );
    an_0 : in STD_LOGIC_VECTOR ( 2 downto 0 );
...
entity embsys_nexys4io_0_0_Digit_7 is
  port (
    ...
    an_0 : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \seg_reg[7]_2\ : in STD_LOGIC_VECTOR ( 7 downto 0 );
...
architecture STRUCTURE of embsys_nexys4io_0_0_sevensegment is
  ...
  signal \FSM_sequential_an[1]_i_4_n_0\ : STD_LOGIC;
  ...
  signal an_0 : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \clk_cnt[0]_i_1_n_0\ : STD_LOGIC;
  signal \clk_cnt[0]_i_3_n_0\ : STD_LOGIC;
  signal clk_cnt_reg : STD_LOGIC_VECTOR ( 17 downto 0 );
  ...
  signal \NLW_clk_cnt_reg[16]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_clk_cnt_reg[16]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_an[2]_i_1\ : label is "soft_lutpair33";
  ...
  attribute SOFT_HLUTNM of \an[0]_INST_0\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \an[1]_INST_0\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \an[2]_INST_0\ : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of \an[3]_INST_0\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \an[4]_INST_0\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \an[5]_INST_0\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \an[6]_INST_0\ : label is "soft_lutpair36";
begin
...
Digit3: entity work.embsys_nexys4io_0_0_Digit_3
     port map (
      ...
      an_0(2 downto 0) => an_0(2 downto 0),
      s00_axi_aclk => s00_axi_aclk,
...
Digit7: entity work.embsys_nexys4io_0_0_Digit_7
     port map (
      ...
      Q(1) => Digit6_n_6,
      Q(0) => Digit6_n_7,
      an_0(1 downto 0) => an_0(1 downto 0),
      s00_axi_aclk => s00_axi_aclk,
      \seg_reg[0]_0\ => Digit7_n_0,
      \seg_reg[1]_0\ => Digit7_n_1,
      \seg_reg[2]_0\ => Digit7_n_2,
...
\FSM_sequential_an[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEFF0100"
        ...
        port map (
      I0 => \FSM_sequential_an[1]_i_4_n_0\,
      I1 => \FSM_sequential_an[1]_i_3_n_0\,
      I2 => \FSM_sequential_an[1]_i_2_n_0\,
...
\FSM_sequential_an[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \FSM_sequential_an[1]_i_2_n_0\,
      I3 => \FSM_sequential_an[1]_i_3_n_0\,
      I4 => \FSM_sequential_an[1]_i_4_n_0\,
      I5 => an_0(1),
      O => \FSM_sequential_an[1]_i_1_n_0\
    );
\FSM_sequential_an[1]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FF7F"
    )
        port map (
...
\FSM_sequential_an[1]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
\FSM_sequential_an[1]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EFFF"
    )
        port map (
      ...
      I2 => clk_cnt_reg(16),
      I3 => clk_cnt_reg(17),
      O => \FSM_sequential_an[1]_i_4_n_0\
    );
...
\FSM_sequential_an[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\FSM_sequential_an[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \FSM_sequential_an[1]_i_2_n_0\,
...
\clk_cnt_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_clk_cnt_reg[16]_i_1_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \clk_cnt_reg[16]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_clk_cnt_reg[16]_i_1_O_UNCONNECTED\(3 downto 2),
      O(1) => \clk_cnt_reg[16]_i_1_n_6\,
      O(0) => \clk_cnt_reg[16]_i_1_n_7\,
      S(3 downto 2) => B"00",
      S(1 downto 0) => clk_cnt_reg(17 downto 16)
    );
...
entity embsys_nexys4io_0_0 is
  ...
  attribute X_CORE_INFO of embsys_nexys4io_0_0 : entity is "nexys4io_v3_0,Vivado 2024.1";
