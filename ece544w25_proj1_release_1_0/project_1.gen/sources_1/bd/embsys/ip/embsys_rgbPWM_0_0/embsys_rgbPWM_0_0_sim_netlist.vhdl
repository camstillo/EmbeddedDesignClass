...
-- Date        : Sun Jan 26 21:30:08 2025
-- Host        : DESKTOP-BFRN34B running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               a:/ECE544_GitHub/ece544w25_proj1_release_1_0/project_1.gen/sources_1/bd/embsys/ip/embsys_rgbPWM_0_0/embsys_rgbPWM_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of embsys_rgbPWM_0_0_rgbPWM is
  ...
  signal \div_count0_inferred__0/i__n_0\ : STD_LOGIC;
  signal \div_count[5]_i_1_n_0\ : STD_LOGIC;
  signal div_count_reg : STD_LOGIC_VECTOR ( 5 downto 1 );
  ...
  attribute SOFT_HLUTNM of \div_count[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \div_count[2]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \div_count[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \div_count[4]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of rgbGREEN_INST_0 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of rgbRED_INST_0 : label is "soft_lutpair2";
begin
  CLK <= \^clk_1\;
...
\div_count0_inferred__0/i_\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAA80000"
    )
        port map (
      ...
      I3 => div_count_reg(3),
      I4 => div_count_reg(5),
      O => \div_count0_inferred__0/i__n_0\
    );
\div_count[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\div_count[1]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\div_count[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"78"
    )
        port map (
...
\div_count[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7F80"
    )
        port map (
      I0 => div_count_reg(1),
      I1 => \div_count_reg_n_0_[0]\,
      I2 => div_count_reg(2),
      I3 => div_count_reg(3),
      O => \p_0_in__0\(3)
    );
\div_count[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFF8000"
    )
        port map (
...
\div_count[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => div_count_reg(4),
      I5 => reset,
      O => \div_count[5]_i_1_n_0\
    );
\div_count[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
div_out_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"60"
    )
        port map (
      I0 => \^clk_1\,
      I1 => \div_count0_inferred__0/i__n_0\,
      I2 => reset,
      O => div_out_i_1_n_0
    );
...
entity embsys_rgbPWM_0_0 is
  ...
  attribute X_CORE_INFO of embsys_rgbPWM_0_0 : entity is "rgbPWM,Vivado 2024.1";
